/*
 * Copyright (C) 2019-2020 The Project-DroidX-UI
 *
...
public class AboutDeviceNamePreferenceController extends BasePreferenceController {
    ...
    private static final String KEY_DEVICE_NAME_PROP = "ro.droidx.device";
    private static final String KEY_SUPPORT_URL = "ro.droidx.build.support_url";
