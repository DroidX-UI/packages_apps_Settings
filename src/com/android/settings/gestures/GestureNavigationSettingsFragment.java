...
import com.droidx.customize.preferences.SystemSettingSwitchPreference;
...
public class GestureNavigationSettingsFragment extends DashboardFragment {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        gestureHintPref.setOnPreferenceChangeListener((preference, newValue) -> {
            if (DroidXUtils.isPackageInstalled(getContext(), NEXUSLAUNCHER_PACKAGE_NAME)) {
                DroidXUtils.toggleOverlay(getContext(), NOGESTUREHINT_OVERLAY, !(Boolean) newValue);
                DroidXUtils.restartApp(NEXUSLAUNCHER_PACKAGE_NAME, getContext());
            }
